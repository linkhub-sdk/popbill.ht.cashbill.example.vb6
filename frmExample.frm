...
' - VB SDK 적용방법 안내 : https://developers.popbill.com/guide/htcashbill/vb/getting-started/tutorial
'
' <테스트 연동개발 준비사항>
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#CheckIsMember
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#CheckID
'=========================================================================
...
'=========================================================================
' 사용자를 연동회원으로 가입처리합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#JoinMember
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetChargeInfo
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#GetAccessURL
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#RegistContact
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#GetContactInfo
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#ListContact
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#UpdateContact
'=========================================================================
...
'=========================================================================
' 연동회원의 회사정보를 확인합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#GetCorpInfo
'=========================================================================
...
'=========================================================================
' 연동회원의 회사정보를 수정합니다
' - https://developers.popbill.com/reference/htcashbill/vb/api/member#UpdateCorpInfo
'=========================================================================
...
'=========================================================================
' 연동회원의 잔여포인트를 확인합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetBalance
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetChargeURL
'=========================================================================
...
' - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetPaymentURL
'=========================================================================
...
' - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetUseHistoryURL
'=========================================================================
...
'=========================================================================
' 파트너의 잔여포인트를 확인합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetPartnerBalance
'=========================================================================
...
' - URL 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetPartnerURL
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/job#RequestJob
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/job#GetJobState
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/job#ListActiveJob
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/search#Search
'=========================================================================
Private Sub btnSearch_Click()
    ...
    rowTmp = "ntsconfirmNum (국세청승인번호) | tradeDate (거래일자) | tradeDT (거래일시) | tradeType (문서형태) | "
    rowTmp = rowTmp + "tradeUsage (거래구분) | totalAmount (거래금액) | supplyCost (공급가액) | tax (부가세) | "
    rowTmp = rowTmp + "serviceFee (봉사료) | invoiceType (매입/매출) | franchiseCorpNum (발행자 사업자번호) | "
    rowTmp = rowTmp + "franchiseCorpName (발행자 상호) | franchiseCorpType (발행자 사업자유형) | identityNum (거래처 식별번호) | "
    rowTmp = rowTmp + "identityNumType (식별번호유형) | customerName (고객명) | cardOwnerName (카드소유자명) | deductionType (공제유형) " + vbCrLf + vbCrLf
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/search#Summary
'=========================================================================
...
' - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetFlatRatePopUpURL
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/point#GetFlatRateState
'=========================================================================
...
' - 반환되는 URL은 보안 정책상 30초 동안 유효하며, 시간을 초과한 후에는 해당 URL을 통한 페이지 접근이 불가합니다.
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#GetCertificatePopUpURL
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#GetCertificateExpireDate
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#CheckCertValidation
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#CheckDeptUser
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#CheckLoginDeptUser
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#DeleteDeptUser
'=========================================================================
...
' - https://developers.popbill.com/reference/htcashbill/vb/api/cert#RegistDeptUser
'=========================================================================
